...
export class IdentityProviderRepositoryAdapter extends EntityRepositoryAdapter<IdentityProvider, IdentityProviderRepository>
    ...
    /**
     * Only a single read carries the extra attributes: the list is the
     * anonymous login surface and must not ship them (issue #3480).
     */
    protected override async extendOne(entity: IdentityProvider): Promise<void> {
