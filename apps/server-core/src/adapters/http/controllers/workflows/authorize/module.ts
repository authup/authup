...
export class AuthorizeController {
    ...
    protected async buildAuthorizeInfo(event: IAppEvent): Promise<AuthorizeInfo> {
        ...
        try {
            ...
            // patterns (the trusted-origin set), grant_types, the home URL,
            // the back-channel logout endpoint, auth methods, or the secret
            // storage flags to an unauthenticated visitor. (ClientEntity.secret
            // is additionally
