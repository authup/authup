...
export class SessionUserAndClientColumns1787571998009 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            ADD "secret" character varying(64)
        `);
        await queryRunner.query(`
            CREATE UNIQUE INDEX "IDX_833c743f7cd787dfc8b70ba400" ON "auth_sessions" ("secret")
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_833c743f7cd787dfc8b70ba400"
        `);
        await queryRunner.query(`
