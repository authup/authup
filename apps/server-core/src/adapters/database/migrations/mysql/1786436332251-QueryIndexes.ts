...
export class QueryIndexes1786436332251 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_f2835b7434c506b81e48a48229\` ON \`auth_scopes\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_5015816deff1b14e7d669ed7cb\` ON \`auth_roles\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_9c08d15bfcf413aad26ee3eda8\` ON \`auth_clients\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_9c861f8e8ea9fe35507b57fb88\` ON \`auth_policies\`
        `);
        await queryRunner.query(`
