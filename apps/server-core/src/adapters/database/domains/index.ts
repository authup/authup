...
export * from './identity-provider-attribute-mapping/index.ts';
export * from './identity-provider-permission-mapping/index.ts';
...
export * from './robot-permission/index.ts';
export * from './robot-role/index.ts';
