...
// WidenClientSecretAndGlobalUniqueness1788782400000 adds a
...
// expression index cannot be described in entity metadata. Issue #3559.
@Index('IDX_auth_permissions_global_name', { synchronize: false })
