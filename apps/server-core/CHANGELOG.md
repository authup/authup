...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @authup/server-kit bumped from ^1.0.0-beta.66 to ^1.0.0-beta.67
    * @authup/specs bumped from ^1.0.0-beta.66 to ^1.0.0-beta.67
  * devDependencies
    * @authup/server-test-kit bumped from ^1.0.0-beta.66 to ^1.0.0-beta.67
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    * @authup/server-test-kit bumped from ^1.0.0-beta.65 to ^1.0.0-beta.66
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @authup/server-kit bumped from ^1.0.0-beta.64 to ^1.0.0-beta.65
    * @authup/specs bumped from ^1.0.0-beta.64 to ^1.0.0-beta.65
  * devDependencies
    * @authup/server-test-kit bumped from ^1.0.0-beta.64 to ^1.0.0-beta.65
...
* **server-core:** `GET /identity-providers/:id` is no longer anonymous.
...
* **deps:** bump the minorandpatch group with 4 updates ([#3472](https://github.com/authup/authup/issues/3472)) ([f10db10](https://github.com/authup/authup/commit/f10db108572b4382f6643780eae7a59a68c729d8))
...
* **server-core:** gate the identity provider record read ([#3483](https://github.com/authup/authup/issues/3483)) ([865641d](https://github.com/authup/authup/commit/865641d5f96c25e58771fdb8c1e75008b715065c))
* **server-core:** writable directory defaults ([#3474](https://github.com/authup/authup/issues/3474)) ([32a6b13](https://github.com/authup/authup/commit/32a6b13737f7acbff4e334a496311b0309fbdf62))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @authup/client-account-console bumped from ^1.0.0-beta.62 to ^1.0.0-beta.63
    * @authup/client-auth-console bumped from ^1.0.0-beta.62 to ^1.0.0-beta.63
    ...
    * @authup/server-kit bumped from ^1.0.0-beta.62 to ^1.0.0-beta.63
    * @authup/specs bumped from ^1.0.0-beta.62 to ^1.0.0-beta.63
  * devDependencies
    * @authup/server-test-kit bumped from ^1.0.0-beta.62 to ^1.0.0-beta.63
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @authup/client-account-console bumped from ^1.0.0-beta.59 to ^1.0.0-beta.60
    * @authup/client-auth-console bumped from ^1.0.0-beta.59 to ^1.0.0-beta.60
    ...
    * @authup/server-kit bumped from ^1.0.0-beta.59 to ^1.0.0-beta.60
    * @authup/specs bumped from ^1.0.0-beta.59 to ^1.0.0-beta.60
  * devDependencies
    * @authup/server-test-kit bumped from ^1.0.0-beta.59 to ^1.0.0-beta.60
...
* the per-realm `web` system client is no longer provisioned. Existing rows survive untouched (still functional, but PUBLIC_URL / TRUSTED_ORIGINS changes no longer propagate to them), and realms created after the upgrade get no `web` client. Downstream applications must register their own client, e.g. once for every realm via a wildcard realm entry; see the migration recipe in docs/src/guide/deployment/upgrading.md. Leftover rows can be removed via the API or a wildcard `absent` child entry.
...
* wildcard realm provisioning, remove the web system client ([#3379](https://github.com/authup/authup/issues/3379)) ([b50c526](https://github.com/authup/authup/commit/b50c52623d51d299310da5a10aa7de35c84a70e1))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @authup/client-account-console bumped from ^1.0.0-beta.58 to ^1.0.0-beta.59
    * @authup/client-auth-console bumped from ^1.0.0-beta.58 to ^1.0.0-beta.59
  ...
  * devDependencies
    * @authup/server-test-kit bumped from ^1.0.0-beta.58 to ^1.0.0-beta.59
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.55 to ^1.0.0-beta.56
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.54 to ^1.0.0-beta.55
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.53 to ^1.0.0-beta.54
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.52 to ^1.0.0-beta.53
...
* validate & harden the rp-initiated logout endpoint (plan 042) ([#3198](https://github.com/authup/authup/issues/3198)) ([54bdaf8](https://github.com/authup/authup/commit/54bdaf8cea57ee110f034d8a5b102a364f793a85))
...
* do not attach undefined identity policy data for global-scoped requests ([#3185](https://github.com/authup/authup/issues/3185)) ([b26a429](https://github.com/authup/authup/commit/b26a429be06ef09fb8f899cc20ab57535cde5290)), closes [#3184](https://github.com/authup/authup/issues/3184)
* gracefully reject invalid identity-provider authorize url ([1ab54ca](https://github.com/authup/authup/commit/1ab54ca23e15dc915febaf2202b005084894c5f3))
* harden DataSource cleanup on setup and migration error paths ([#3181](https://github.com/authup/authup/issues/3181)) ([7e43cab](https://github.com/authup/authup/commit/7e43cabf3a3455f105073389749429f3919e4579))
...
* realm_id property comparision in authorization module ([f34c4f7](https://github.com/authup/authup/commit/f34c4f73956e83cd7bfd1616c62a78cc2753d706))
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.51 to ^1.0.0-beta.52
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.49 to ^1.0.0-beta.50
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.48 to ^1.0.0-beta.49
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.46 to ^1.0.0-beta.47
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.45 to ^1.0.0-beta.46
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.44 to ^1.0.0-beta.45
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.42 to ^1.0.0-beta.44
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @authup/server-test-kit bumped from ^1.0.0-beta.41 to ^1.0.0-beta.42
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    * @authup/client-web-slim bumped from ^1.0.0-beta.35 to ^1.0.0-beta.36
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    * @authup/client-web-slim bumped from ^1.0.0-beta.31 to ^1.0.0-beta.32
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    * @authup/client-web-slim bumped from ^1.0.0-beta.30 to ^1.0.0-beta.31
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @authup/server-kit bumped from ^1.0.0-beta.29 to ^1.0.0-beta.30
    * @authup/specs bumped from ^1.0.0-beta.29 to ^1.0.0-beta.30
  * devDependencies
    * @authup/client-web-slim bumped from ^1.0.0-beta.29 to ^1.0.0-beta.30
