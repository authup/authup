...
<template>
    <div>
        <div class="page-sidebar">
            ...
            <div class="mt-auto">
                <!--
                    The renewal countdown reads the access token's expiry,
                    which a cookie session (plan 088) does not have: the
                    server slides the session itself, so there is nothing
                    to count down to.
                -->
                <div
                    v-if="authenticated && tokenExpiresIn > 0"
