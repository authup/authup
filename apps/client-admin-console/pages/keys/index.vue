...
export default defineNuxtComponent({
    ...
    setup() {
        ...
        const breadcrumbItems = useSectionBreadcrumb(LayoutSection.KEYS, { add: true });
        const sectionUrls = buildSectionURLs(LayoutSection.KEYS);
        ...
        const translationsApp = useTranslationsForNamespace(
            ...
            [
                { key: TranslatorTranslationAppKey.KEY_DESCRIPTION },
            ],
        );
    ...
    <div>
        ...
        <div class="mb-3 flex flex-wrap items-start justify-between gap-3">
            <div>
                ...
                <p class="sub-title">
                    {{ translationsApp.keyDescription }}
                </p>
            </div>
            <AContentAction
