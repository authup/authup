import{_ as i,o as a,c as n,ae as l}from"./chunks/framework.Co1PSFSm.js";const c=JSON.parse('{"title":"Configuration","description":"","frontmatter":{},"headers":[],"relativePath":"guide/deployment/configuration-server-core.md","filePath":"guide/deployment/configuration-server-core.md"}'),p={name:"guide/deployment/configuration-server-core.md"};function t(e,s,h,k,r,d){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="configuration" tabindex="-1">Configuration <a class="header-anchor" href="#configuration" aria-label="Permalink to &quot;Configuration&quot;">​</a></h1><p>The API configuration can be provided in different file formats, such as <code>authup.server.core.{conf,js,ts,...}</code>.</p><p>The environment variables in the .env file variant can also be provided via runtime environment.</p><div class="danger custom-block"><p class="custom-block-title">Security</p><p>Always change the default admin password (<code>start123</code>) and robot secret before deploying to production.</p></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-oSFjT" id="tab-KpH8rEP" checked><label data-title="authup.server.core.ts" for="tab-KpH8rEP">authup.server.core.ts</label><input type="radio" name="group-oSFjT" id="tab-2GLGznV"><label data-title="authup.server.core.conf" for="tab-2GLGznV">authup.server.core.conf</label><input type="radio" name="group-oSFjT" id="tab-pgfmY7f"><label data-title=".env" for="tab-pgfmY7f">.env</label></div><div class="blocks"><div class="language-typescript vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
