import{_ as i,o as a,c as n,a0 as l}from"./chunks/framework.DOOm19uJ.js";const g=JSON.parse('{"title":"Configuration","description":"","frontmatter":{},"headers":[],"relativePath":"guide/deployment/configuration-server-core.md","filePath":"guide/deployment/configuration-server-core.md"}'),p={name:"guide/deployment/configuration-server-core.md"};function e(t,s,h,k,r,d){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="configuration" tabindex="-1">Configuration <a class="header-anchor" href="#configuration" aria-label="Permalink to &quot;Configuration&quot;">​</a></h1><p>The API configuration can be provided in different file formats, such as <code>authup.server.core.{conf,js,ts,...}</code>.</p><p>The environment variables in the .env file variant can also be provided via runtime environment.</p><div class="danger custom-block"><p class="custom-block-title">Security</p><p>Always change the default admin password (<code>start123</code>) and robot secret before deploying to production.</p></div><p>For MFA enforcement behavior and its federated-login, password-grant, feature-toggle, and cache-availability boundaries, see <a href="./configuration-server-core-mfa.html">Multi-factor authentication</a>.</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Pdeiv" id="tab-QJ7WX3B" checked><label data-title="authup.server.core.ts" for="tab-QJ7WX3B">authup.server.core.ts</label><input type="radio" name="group-Pdeiv" id="tab-6gVALvi"><label data-title="authup.server.core.conf" for="tab-6gVALvi">authup.server.core.conf</label><input type="radio" name="group-Pdeiv" id="tab-yOZb7t5"><label data-title=".env" for="tab-yOZb7t5">.env</label></div><div class="blocks"><div class="language-typescript vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
