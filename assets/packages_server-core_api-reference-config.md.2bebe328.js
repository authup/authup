import{_ as s,o as n,c as a,f as l}from"./app.8f9e1ecd.js";const A=JSON.parse('{"title":"Config","description":"","frontmatter":{},"headers":[{"level":2,"title":"setConfig","slug":"setconfig","link":"#setconfig","children":[]},{"level":2,"title":"useConfig","slug":"useconfig","link":"#useconfig","children":[]},{"level":2,"title":"useConfigSync","slug":"useconfigsync","link":"#useconfigsync","children":[]},{"level":2,"title":"Config","slug":"config-1","link":"#config-1","children":[]}],"relativePath":"packages/server-core/api-reference-config.md"}'),p={name:"packages/server-core/api-reference-config.md"},o=l(`<h1 id="config" tabindex="-1">Config <a class="header-anchor" href="#config" aria-hidden="true">#</a></h1><h2 id="setconfig" tabindex="-1"><code>setConfig</code> <a class="header-anchor" href="#setconfig" aria-hidden="true">#</a></h2><p>The <code>setConfig()</code> method, specify options for all submodules:</p><p><strong>Type</strong></p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki"><code><span class="line"><span style="color:#C792EA;">function</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">setConfig</span><span style="color:#89DDFF;">(</span><span style="color:#A6ACCD;">value</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Subset</span><span style="color:#89DDFF;">&lt;</span><span style="color:#FFCB6B;">Config</span><span style="color:#89DDFF;">&gt;)</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Config</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span></code></pre></div><p><strong>Example</strong></p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki"><code><span class="line"><span style="color:#82AAFF;">setConfig</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"></span></code></pre></div>`,24),e=[o];function c(t,r,y,i,C,D){return n(),a("div",null,e)}const d=s(p,[["render",c]]);export{A as __pageData,d as default};
