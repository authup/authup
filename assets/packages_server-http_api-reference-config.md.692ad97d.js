import{_ as s,o as n,c as a,f as l}from"./app.0d7047cb.js";const A=JSON.parse('{"title":"Config","description":"","frontmatter":{},"headers":[{"level":2,"title":"useConfig","slug":"useconfig","link":"#useconfig","children":[]},{"level":2,"title":"setConfigOptions","slug":"setconfigoptions","link":"#setconfigoptions","children":[]},{"level":2,"title":"Options","slug":"options","link":"#options","children":[]},{"level":2,"title":"OptionsInput","slug":"optionsinput","link":"#optionsinput","children":[]}],"relativePath":"packages/server-http/api-reference-config.md"}'),p={name:"packages/server-http/api-reference-config.md"},o=l(`<h1 id="config" tabindex="-1">Config <a class="header-anchor" href="#config" aria-hidden="true">#</a></h1><h2 id="useconfig" tabindex="-1"><code>useConfig</code> <a class="header-anchor" href="#useconfig" aria-hidden="true">#</a></h2><p>The <code>useConfig()</code> method returns the configuration class. If no configuration is set, the method will use default options.</p><p><strong>Type</strong></p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki"><code><span class="line"><span style="color:#C792EA;">declare</span><span style="color:#A6ACCD;"> </span><span style="color:#C792EA;">function</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">useConfig</span><span style="color:#89DDFF;">()</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Config</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span></code></pre></div><h2 id="setconfigoptions" tabindex="-1"><code>setConfigOptions</code> <a class="header-anchor" href="#setconfigoptions" aria-hidden="true">#</a></h2><p>The <code>setConfigOptions()</code> method can be used to set/append config options:</p><p><strong>Type</strong></p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki"><code><span class="line"><span style="color:#C792EA;">declare</span><span style="color:#A6ACCD;"> </span><span style="color:#C792EA;">function</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">setConfigOptions</span><span style="color:#89DDFF;">(</span><span style="color:#A6ACCD;">value</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">OptionsInput</span><span style="color:#89DDFF;">);</span></span>
<span class="line"></span></code></pre></div><p><strong>Example</strong></p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki"><code><span class="line"><span style="color:#82AAFF;">setConfigOptions</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F07178;">tokenMaxAgeAccessToken</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#F78C6C;">7200</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> </span><span style="color:#676E95;">// 3 hours</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;">/**</span></span>
<span class="line"><span style="color:#676E95;">     * Relative/absolute path to the writable directory.</span></span>
<span class="line"><span style="color:#676E95;">     * default: path.join(process.cwd(), &#39;writable&#39;)</span></span>
<span class="line"><span style="color:#676E95;">     */</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;">/**</span></span>
<span class="line"><span style="color:#676E95;">     * use body middleware</span></span>
<span class="line"><span style="color:#676E95;">     *</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;">/**</span></span>
<span class="line"><span style="color:#676E95;">     * use cookie middleware</span></span>
<span class="line"><span style="color:#676E95;">     *</span></span>
<span class="line"><span style="color:#676E95;">     * default: true</span></span>
<span class="line"><span style="color:#676E95;">     */</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;">/**</span></span>
<span class="line"><span style="color:#676E95;">     * use swagger middleware</span></span>
<span class="line"><span style="color:#676E95;">     *</span></span>
<span class="line"><span style="color:#676E95;">     * default: true</span></span>
<span class="line"><span style="color:#676E95;">     */</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;">/**</span></span>
<span class="line"><span style="color:#676E95;">     * Enable registration.</span></span>
<span class="line"><span style="color:#676E95;">     *</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;">/**</span></span>
<span class="line"><span style="color:#676E95;">     * Email verification required for registration or login with identity provider.</span></span>
<span class="line"><span style="color:#676E95;">     *</span></span>
<span class="line"><span style="color:#676E95;">     * default: false</span></span>
<span class="line"><span style="color:#676E95;">     */</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;">/**</span></span>
<span class="line"><span style="color:#676E95;">     * Allow password reset?</span></span>
<span class="line"><span style="color:#676E95;">     *</span></span>
<span class="line"><span style="color:#676E95;">     * default: false</span></span>
<span class="line"><span style="color:#676E95;">     */</span></span>
...
<span class="line"></span></code></pre></div>`,17),e=[o];function t(c,r,i,y,C,D){return n(),a("div",null,e)}const d=s(p,[["render",t]]);export{A as __pageData,d as default};
