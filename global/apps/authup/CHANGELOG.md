...
## [1.0.0](https://github.com/authup/authup/compare/global-authup-app-v0.45.10...global-authup-app-v1.0.0) (2023-12-21)
...
* The following workspace dependencies were updated
  * dependencies
    * @authup/client-web-app bumped from ^0.45.10 to ^1.0.0
    * @authup/core bumped from ^0.45.10 to ^1.0.0
    * @authup/server-core-app bumped from ^0.45.10 to ^1.0.0
