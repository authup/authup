...
## [1.0.0](https://github.com/authup/authup/compare/global-authup-v0.45.10...global-authup-v1.0.0) (2024-01-04)
...
* The following workspace dependencies were updated
  * dependencies
    * @authup/client-web bumped from ^0.45.10 to ^1.0.0
    * @authup/client-web-config bumped from ^0.0.0 to ^1.0.0
    * @authup/config bumped from ^0.0.0 to ^1.0.0
