...
const configValidation = zod.object({
    ...
    databaseAdminUsername: zod.string().min(3).max(128),
    databaseAdminPassword: zod.string().min(3).max(256),
    databaseAdminPasswordReset: zod.boolean().optional(),
    databaseRobotEnabled: zod.boolean(),
    databaseRobotSecret: zod.string().min(3).max(256),
    databaseRobotSecretReset: zod.boolean().optional(),
    databasePermissions: zod.string().array().optional(),
