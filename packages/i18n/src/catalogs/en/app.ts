...
export const TranslatorTranslationAppEnglish : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.PATH_SCOPE_FAILED]: 'The folder could not be loaded, so nothing is listed.',
    [TranslatorTranslationAppKey.PATH_SCOPE_MISSING]: 'This folder no longer exists, so nothing is listed.',
