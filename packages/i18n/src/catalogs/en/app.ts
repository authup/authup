...
export const TranslatorTranslationAppEnglish : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.ACTIVITY_CREATED]: 'Created',
    [TranslatorTranslationAppKey.ACTIVITY_UPDATED]: 'Updated',
    [TranslatorTranslationAppKey.ACTIVITY_DELETED]: 'Deleted',
    [TranslatorTranslationAppKey.ACTIVITY_SOURCE]: 'Created, updated and deleted are counted from the audit log.',
    [TranslatorTranslationAppKey.ACTIVITY_IN_DAYS]: 'in {{days}} days',
    [TranslatorTranslationAppKey.ACTIVITY_IN_HOURS]: 'in {{hours}} hours',
    [TranslatorTranslationAppKey.ACTIVITY_ALL_TIME]: 'all time',
    [TranslatorTranslationAppKey.STATS_WINDOW_RETAINED]: 'The audit log keeps these records for {{days}} days.',
