...
export const TranslatorTranslationEntityEnglish : NamespaceTranslations<`${TranslatorTranslationEntityKey}`> = {
    ...
    [TranslatorTranslationEntityKey.PATH]: definePlural({ one: 'Path', other: 'Paths' }),
    ...
    [TranslatorTranslationEntityKey.SESSION_TOKEN]: definePlural({ one: 'Session token', other: 'Session tokens' }),
