...
export const TranslatorTranslationFieldEnglish : NamespaceTranslations<`${TranslatorTranslationFieldKey}`> = {
    ...
    [TranslatorTranslationFieldKey.BASE_URL]: 'Home URL',
    ...
    [TranslatorTranslationFieldKey.ENROLLMENT_ENABLED]: 'Allow new users',
    [TranslatorTranslationFieldKey.ENROLLMENT_ENABLED_HINT]: 'Switched off, only users already linked to this provider can sign in.',
    [TranslatorTranslationFieldKey.ENROLLMENT_POLICY]: 'New-user policy',
    [TranslatorTranslationFieldKey.ENROLLMENT_POLICY_HINT]: 'Evaluated against the user about to be created. A denial refuses the login. Empty allows everyone.',
