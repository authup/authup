...
export const TranslatorTranslationAppGerman : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.ACTIVITY_TOTAL]: 'Gesamt',
    [TranslatorTranslationAppKey.ACTIVITY_CREATED]: 'Erstellt',
    [TranslatorTranslationAppKey.ACTIVITY_UPDATED]: 'Aktualisiert',
    [TranslatorTranslationAppKey.ACTIVITY_DELETED]: 'Gelöscht',
    [TranslatorTranslationAppKey.ACTIVITY_SOURCE]: 'Erstellt, aktualisiert und gelöscht werden aus dem Audit-Log gezählt.',
    [TranslatorTranslationAppKey.ACTIVITY_IN_DAYS]: 'in {{days}} Tagen',
    [TranslatorTranslationAppKey.ACTIVITY_IN_HOURS]: 'in {{hours}} Stunden',
    [TranslatorTranslationAppKey.ACTIVITY_ALL_TIME]: 'insgesamt',
    [TranslatorTranslationAppKey.STATS_WINDOW_RETAINED]: 'Das Audit-Log bewahrt diese Einträge {{days}} Tage auf.',
