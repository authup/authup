...
export const TranslatorTranslationClientGerman : NamespaceTranslations<`${TranslatorTranslationClientKey}`> = {
    ...
    [TranslatorTranslationClientKey.SECRET_ROTATE]: 'Geheimnis rotieren',
    [TranslatorTranslationClientKey.SECRET_ROTATE_HINT]: 'Leer lassen, damit der Server ein Geheimnis erzeugt.',
    [TranslatorTranslationClientKey.SECRET_HASHED_HINT]: 'Das Geheimnis ist gehasht gespeichert und kann nicht angezeigt werden. Rotiere es, um ein neues zu setzen.',
    ...
    [TranslatorTranslationClientKey.RETURNING_TO_APP]: 'Weiterleitung zu {{client}}',
    [TranslatorTranslationClientKey.OPEN_APP]: 'Anwendung öffnen',
