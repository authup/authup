...
export const TranslatorTranslationAppSpanish : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.DASHBOARD_LOGINS]: 'Inicios de sesión',
    ...
    [TranslatorTranslationAppKey.STATS_NEW]: '+{{count}} nuevos',
    ...
    [TranslatorTranslationAppKey.STATS_STRIP_SUMMARY]: 'Actividad diaria de los últimos {{days}} días: {{count}} nuevos, {{total}} en total.',
