...
export const TranslatorTranslationAppFrench : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.REALM_DESCRIPTION]: 'Domaines isolés, chacun avec ses propres utilisateurs, clients et clés.',
    [TranslatorTranslationAppKey.CLIENT_DESCRIPTION]: 'Applications qui s\'authentifient auprès d\'Authup.',
    [TranslatorTranslationAppKey.SCOPE_DESCRIPTION]: 'Portées qu\'un client peut demander lors d\'une demande d\'accès.',
    [TranslatorTranslationAppKey.IDENTITY_PROVIDER_DESCRIPTION]: 'Fournisseurs externes permettant aux utilisateurs de se connecter.',
    [TranslatorTranslationAppKey.KEY_DESCRIPTION]: 'Clés de signature et de chiffrement, un magasin par domaine.',
    [TranslatorTranslationAppKey.TRUST_ANCHOR_DESCRIPTION]: 'Certificats CA de confiance pour l\'authentification par certificat client.',
    [TranslatorTranslationAppKey.USER_DESCRIPTION]: 'Comptes qui se connectent aux applications.',
    [TranslatorTranslationAppKey.ROLE_DESCRIPTION]: 'Ensembles nommés de permissions, attribués aux utilisateurs et aux clients.',
    [TranslatorTranslationAppKey.PERMISSION_DESCRIPTION]: 'Capacités individuelles pouvant être accordées à une identité.',
    ...
    [TranslatorTranslationAppKey.DASHBOARD]: 'Tableau de bord',
    [TranslatorTranslationAppKey.DASHBOARD_DESCRIPTION]: 'Connexions, autorisations et événements de ce domaine en un coup d\'œil.',
    [TranslatorTranslationAppKey.DASHBOARD_WINDOW]: 'Période',
    [TranslatorTranslationAppKey.DASHBOARD_WINDOW_24H]: 'Dernières 24 heures',
    [TranslatorTranslationAppKey.DASHBOARD_WINDOW_7D]: '7 derniers jours',
    [TranslatorTranslationAppKey.DASHBOARD_WINDOW_30D]: '30 derniers jours',
    [TranslatorTranslationAppKey.DASHBOARD_WINDOW_90D]: '90 derniers jours',
    [TranslatorTranslationAppKey.DASHBOARD_LOGINS]: 'Connexions réussies',
    [TranslatorTranslationAppKey.DASHBOARD_LOGINS_FAILED]: 'Connexions échouées',
    [TranslatorTranslationAppKey.DASHBOARD_AUTHORIZATIONS]: 'Autorisations',
    [TranslatorTranslationAppKey.DASHBOARD_EVENTS]: 'Événements',
    [TranslatorTranslationAppKey.DASHBOARD_LOGIN_VOLUME]: 'Connexions dans le temps',
    [TranslatorTranslationAppKey.DASHBOARD_EVENTS_BY_TYPE]: 'Événements par type',
    [TranslatorTranslationAppKey.DASHBOARD_EVENTS_LINK]: 'Voir tous les événements',
    [TranslatorTranslationAppKey.DASHBOARD_EMPTY]: 'Aucun événement sur cette période.',
    [TranslatorTranslationAppKey.DASHBOARD_EVENT_LOG_DISABLED]: 'Le journal des événements est désactivé : rien n\'est enregistré et il n\'y a rien à afficher ici. Activez-le avec EVENT_LOG_ENABLED.',
    [TranslatorTranslationAppKey.DASHBOARD_IDENTITIES]: 'Identités',
    [TranslatorTranslationAppKey.DASHBOARD_CONFIGURATION]: 'Configuration',
    [TranslatorTranslationAppKey.SESSIONS_ACTIVE]: 'Sessions actives',
    [TranslatorTranslationAppKey.STATS_NEW]: 'Nouveaux : +{{count}}',
    [TranslatorTranslationAppKey.STATS_NEW_IN_DAYS]: '+{{count}} en {{days}} jours',
    [TranslatorTranslationAppKey.STATS_NEW_IN_HOURS]: '+{{count}} en {{hours}} heures',
    [TranslatorTranslationAppKey.STATS_STRIP_SUMMARY]: 'Activité quotidienne des {{days}} derniers jours. Nouveaux : {{count}}. Total : {{total}}.',
    ...
    [TranslatorTranslationAppKey.ISSUER]: 'Émetteur',
    [TranslatorTranslationAppKey.OPENID_CONFIGURATION_URL]: 'URL de configuration OpenID',
    [TranslatorTranslationAppKey.JWKS_URL]: 'URL JWKS',
    ...
    [TranslatorTranslationAppKey.CONSENT_REVOKE_ALL_SUCCESS]: 'L\'accès de l\'application a été révoqué.',
