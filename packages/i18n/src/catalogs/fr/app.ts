...
export const TranslatorTranslationAppFrench : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.ACTIVITY_CREATED]: 'Créés',
    [TranslatorTranslationAppKey.ACTIVITY_UPDATED]: 'Modifiés',
    [TranslatorTranslationAppKey.ACTIVITY_DELETED]: 'Supprimés',
    [TranslatorTranslationAppKey.ACTIVITY_SOURCE]: "Les créations, modifications et suppressions sont comptées d'après le journal d'audit.",
    [TranslatorTranslationAppKey.ACTIVITY_IN_DAYS]: 'sur {{days}} jours',
    [TranslatorTranslationAppKey.ACTIVITY_IN_HOURS]: 'sur {{hours}} heures',
    [TranslatorTranslationAppKey.ACTIVITY_ALL_TIME]: 'depuis toujours',
    [TranslatorTranslationAppKey.STATS_WINDOW_RETAINED]: "Le journal d'audit conserve ces entrées {{days}} jours.",
