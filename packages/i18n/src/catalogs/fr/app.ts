...
export const TranslatorTranslationAppFrench : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.PATH_SCOPE_FAILED]: 'Le dossier n\'a pas pu être chargé, donc rien n\'est affiché.',
    [TranslatorTranslationAppKey.PATH_SCOPE_MISSING]: 'Ce dossier n\'existe plus, donc rien n\'est affiché.',
