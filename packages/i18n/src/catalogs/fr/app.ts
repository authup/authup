...
export const TranslatorTranslationAppFrench : NamespaceTranslations<`${TranslatorTranslationAppKey}`> = {
    ...
    [TranslatorTranslationAppKey.DASHBOARD_LOGINS]: 'Connexions',
    ...
    [TranslatorTranslationAppKey.STATS_NEW]: '+{{count}} nouveaux',
    ...
    [TranslatorTranslationAppKey.STATS_STRIP_SUMMARY]: 'Activité quotidienne des {{days}} derniers jours : {{count}} nouveaux, {{total}} au total.',
