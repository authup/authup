...
export const TranslatorTranslationFieldFrench : NamespaceTranslations<`${TranslatorTranslationFieldKey}`> = {
    ...
    [TranslatorTranslationFieldKey.POST_LOGOUT_REDIRECT_URIS]: 'URI(s) de redirection après déconnexion',
    [TranslatorTranslationFieldKey.BASE_URL]: 'URL d\'accueil',
    [TranslatorTranslationFieldKey.BACKCHANNEL_LOGOUT_URI]: 'URL de déconnexion back-channel',
    [TranslatorTranslationFieldKey.GRANT_TYPES]: 'Types d’autorisation',
    ...
    [TranslatorTranslationFieldKey.NAMES]: 'Noms',
    [TranslatorTranslationFieldKey.PASSWORD_REPEAT]: 'Répéter le mot de passe',
    [TranslatorTranslationFieldKey.ID]: 'ID',
    [TranslatorTranslationFieldKey.TYPE]: 'Type',
    [TranslatorTranslationFieldKey.TYPES]: 'Types',
    [TranslatorTranslationFieldKey.INVERT]: 'Inverser ?',
    [TranslatorTranslationFieldKey.ENABLED]: 'Activé ?',
    [TranslatorTranslationFieldKey.CHILDREN]: 'Enfants',
    [TranslatorTranslationFieldKey.CREATED_AT]: 'Créé le',
    [TranslatorTranslationFieldKey.UPDATED_AT]: 'Mis à jour le',
    [TranslatorTranslationFieldKey.SEEN_AT]: 'Vu pour la dernière fois',
    [TranslatorTranslationFieldKey.EXPIRES_AT]: 'Expire le',
    [TranslatorTranslationFieldKey.IP_ADDRESS]: 'Adresse IP',
    [TranslatorTranslationFieldKey.USER_AGENT]: 'Agent utilisateur',
    [TranslatorTranslationFieldKey.AUTH_METHOD]: 'Méthode d\'authentification',
    [TranslatorTranslationFieldKey.KIND]: 'Type',
    [TranslatorTranslationFieldKey.SUBJECT]: 'Sujet',
    [TranslatorTranslationFieldKey.REFRESHED_AT]: 'Renouvelé le',
    [TranslatorTranslationFieldKey.MFA_AT]: 'MFA vérifiée le',
    [TranslatorTranslationFieldKey.PROTOCOL]: 'Protocole',
    [TranslatorTranslationFieldKey.PROTOCOLS]: 'Protocoles',
    [TranslatorTranslationFieldKey.PRESET]: 'Préréglage',
    [TranslatorTranslationFieldKey.PRESETS]: 'Préréglages',
    [TranslatorTranslationFieldKey.TIMEOUT]: 'Délai d\'attente',
    [TranslatorTranslationFieldKey.START_TLS]: 'StartTLS',
    [TranslatorTranslationFieldKey.BASE_DN]: 'DN de base',
    [TranslatorTranslationFieldKey.FILTER]: 'Filtre',
    [TranslatorTranslationFieldKey.CLASS]: 'Classe',
    [TranslatorTranslationFieldKey.NAME_ATTRIBUTE]: 'Attribut de nom',
    [TranslatorTranslationFieldKey.MAIL_ATTRIBUTE]: 'Attribut d\'e-mail',
    [TranslatorTranslationFieldKey.DISPLAY_NAME_ATTRIBUTE]: 'Attribut du nom d\'affichage',
    [TranslatorTranslationFieldKey.MEMBER_ATTRIBUTE]: 'Attribut de membre',
    ...
    [TranslatorTranslationFieldKey.ENROLLMENT_ENABLED]: 'Autoriser les nouveaux utilisateurs',
    [TranslatorTranslationFieldKey.ENROLLMENT_ENABLED_HINT]: 'Désactivé, seuls les utilisateurs déjà liés à ce fournisseur peuvent se connecter.',
    [TranslatorTranslationFieldKey.ENROLLMENT_POLICY]: 'Politique des nouveaux utilisateurs',
    [TranslatorTranslationFieldKey.ENROLLMENT_POLICY_HINT]: 'Évaluée sur l\'utilisateur à créer. Un refus rejette la connexion. Vide autorise tout le monde.',
    ...
    [TranslatorTranslationFieldKey.ACCESS_POLICY]: 'Politique d\'accès',
    [TranslatorTranslationFieldKey.ACTOR]: 'Acteur',
    [TranslatorTranslationFieldKey.REF]: 'Référence',
    [TranslatorTranslationFieldKey.PARENT]: 'Parent',
