...
export const TranslatorTranslationClientFrench : NamespaceTranslations<`${TranslatorTranslationClientKey}`> = {
    ...
    [TranslatorTranslationClientKey.SECRET_ROTATE]: 'Renouveler le secret',
    [TranslatorTranslationClientKey.SECRET_ROTATE_HINT]: 'Laissez le secret vide pour que le serveur en génère un.',
    [TranslatorTranslationClientKey.SECRET_HASHED_HINT]: 'Le secret est stocké haché et ne peut pas être affiché. Renouvelez-le pour en définir un nouveau.',
    ...
    [TranslatorTranslationClientKey.RETURNING_TO_APP]: 'Redirection vers {{client}}',
    [TranslatorTranslationClientKey.OPEN_APP]: 'Ouvrir l\'application',
