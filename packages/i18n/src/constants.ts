...
export enum TranslatorTranslationClientKey {
    ...
    BACKCHANNEL_LOGOUT_URI_HINT = 'backchannelLogoutURIHint',
    ...
    SECRET_ROTATE_HINT = 'secretRotateHint',
    SECRET_HASHED_HINT = 'secretHashedHint',
...
export enum TranslatorTranslationAppKey {
    ...
    DASHBOARD_WINDOW_24H = 'dashboardWindow24h',
    DASHBOARD_WINDOW_7D = 'dashboardWindow7d',
    DASHBOARD_WINDOW_30D = 'dashboardWindow30d',
    DASHBOARD_WINDOW_90D = 'dashboardWindow90d',
    DASHBOARD_LOGINS = 'dashboardLogins',
    DASHBOARD_LOGINS_FAILED = 'dashboardLoginsFailed',
    DASHBOARD_AUTHORIZATIONS = 'dashboardAuthorizations',
    DASHBOARD_EVENTS = 'dashboardEvents',
    DASHBOARD_LOGIN_VOLUME = 'dashboardLoginVolume',
    DASHBOARD_EVENTS_BY_TYPE = 'dashboardEventsByType',
    ...
    PATH_SCOPE_FAILED = 'pathScopeFailed',
    PATH_SCOPE_MISSING = 'pathScopeMissing',
...
export enum TranslatorTranslationFieldKey {
    ...
    REQUIRED_AMR_HINT = 'requiredAmrHint',
    REQUIRED_ACR = 'requiredAcr',
    REQUIRED_ACR_HINT = 'requiredAcrHint',
    ENROLLMENT_ENABLED = 'enrollmentEnabled',
    ENROLLMENT_ENABLED_HINT = 'enrollmentEnabledHint',
    ENROLLMENT_POLICY = 'enrollmentPolicy',
    ENROLLMENT_POLICY_HINT = 'enrollmentPolicyHint',
    TOKEN = 'token',
    USER_INFO = 'userInfo',
    DISCOVERY = 'discovery',
    REDIRECT_URL = 'redirectUrl',
