...
export enum EnvironmentVariable {
    ...
    PROVISIONING_DIRECTORY_PATH = 'PROVISIONING_DIRECTORY_PATH',
    ...
    QUERY_SCHEMA_DISCOVERY_ENABLED = 'QUERY_SCHEMA_DISCOVERY_ENABLED',
    ...
    EVENT_LOG_AGGREGATE_RETENTION_DAYS = 'EVENT_LOG_AGGREGATE_RETENTION_DAYS',
