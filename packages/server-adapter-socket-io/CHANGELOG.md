...
## [1.0.1-beta.65](https://github.com/authup/authup/compare/v1.0.0-beta.65...v1.0.1-beta.65) (2026-09-15)
...
* The following workspace dependencies were updated
  * dependencies
    * @authup/server-adapter-kit bumped from ^1.0.0-beta.65 to ^1.0.1-beta.65
