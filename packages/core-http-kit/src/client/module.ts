...
export class Client extends BaseClient implements IClient {
    ...
    public readonly deviceAuthorization : OAuth2DeviceAuthorizationAPI;

    public readonly event : EventAPI;

    public readonly identityProvider : IdentityProviderAPI;

    public readonly identityProviderAccount : IdentityProviderAccountAPI;
    ...
    public readonly sessionToken : SessionTokenAPI;
    ...
    constructor(config: ClientOptions = {}) {
        ...
        this.deviceAuthorization = new OAuth2DeviceAuthorizationAPI({ client: this });

        this.event = new EventAPI({ client: this });

        this.identityProvider = new IdentityProviderAPI({ client: this });
        this.identityProviderAccount = new IdentityProviderAccountAPI({ client: this });
        ...
        this.schema = new SchemaAPI({ client: this });
        this.scope = new ScopeAPI({ client: this });

        this.session = new SessionAPI({ client: this });
        this.sessionToken = new SessionTokenAPI({ client: this });
