...
* The following workspace dependencies were updated
  * devDependencies
    * @authup/client-web-kit bumped from ^1.0.0-beta.11 to ^1.0.1-beta.11
    * @authup/config bumped from ^1.0.0-beta.11 to ^1.0.1-beta.11
    ...
    * @authup/client-web-config bumped from ^1.0.0-beta.11 to ^1.0.1-beta.11
