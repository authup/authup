...
## [1.0.0-beta.21](https://github.com/authup/authup/compare/v1.0.0-beta.21...v1.0.0-beta.21) (2024-10-18)
...
* The following workspace dependencies were updated
  * devDependencies
    ...
    * @authup/client-web-nuxt bumped from ^1.0.0-beta.21 to ^1.0.1-beta.21
