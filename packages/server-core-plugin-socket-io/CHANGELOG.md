...
## [1.1.0-beta.11](https://github.com/authup/authup/compare/v1.0.0-beta.11...v1.1.0-beta.11) (2024-05-10)
...
* The following workspace dependencies were updated
  * dependencies
    * @authup/server-core-plugin-kit bumped from ^1.0.0-beta.11 to ^1.1.0-beta.11
  * devDependencies
